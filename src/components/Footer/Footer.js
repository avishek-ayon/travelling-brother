        ...
        <div className="footer my-4 py-4">
            <div className='footer-1at-row'>
                <div>
                    ...
                    <p className=' text-white'><small>Dynamo sqaure 3rd Floor, washingTon D.C ,158/E, Renana  Marium Nur, Bangkok,Bangladesh</small></p>
            ...
            <div className='footer-2nd-row mt-4'>
                <div>
                    <p className='text-primary'> <i class="fas fa-envelope"></i> travallingVai@gmail.com</p>
                    <p className='text-primary'><i class="fas fa-phone-alt"></i>  0231553355</p>
            ...
            <p className='text-white text-center mt-2'>Copyright @ 2021.  Travelling vai. All rights reserved.</p>
